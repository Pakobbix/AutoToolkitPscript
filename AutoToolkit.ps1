...
InVoke-WebRequest "https://raw.githubusercontent.com/Pakobbix/AutoToolkitPscript/master/AutoToolkit.ps1" "C:\WWiU\AutoToolkit.ps1"
...
$mostRecent = 'C:\WWiU\AutoToolkit.ps1'
